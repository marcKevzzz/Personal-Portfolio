...
function renderProjects(projects) {
  ...
  projects.forEach(function (proj, idx) {
    ...
    var rawImg = proj.ImagePath || "Assets/Images/samsondentalcenter.png";
    var imgPath = "/" + rawImg.replace(/^~?\/+/, "");
    ...
    html +=
      ...
      '" loading="lazy" onerror="this.onerror=null;this.src=\'/Assets/Images/samsondentalcenter.png\';" />' +
      "</div>" +
      '<span class="tile-num">' +
      pNum +
      "</span>" +
