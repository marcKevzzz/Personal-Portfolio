...
<div class="admin-panel" data-panel="contacts">
    ...
    <div class="add-form" >
        ...
        <div class="field">
            <label>Display Label</span></label>
            <div class="input-row">
        ...
        <div class="field">
            <label>Custom Link / Protocol</span></label>
            <div class="input-row">
        ...
        <div style="display: flex; align-items: flex-end; gap: 10px;">
            <asp:Button ID="btnAddContact" runat="server" Text="Add Contact" CssClass="btn btn-primary" OnClick="btnAddContact_Click" data-confirm-title="Add Contact" data-confirm-msg="Are you sure you want to add this contact or social channel?" data-confirm-btn="Add Contact" style="flex: 1; justify-content: center;" />
