<%@ Page Title="Website Builder" Language="C#" MasterPageFile="~/Pages/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PortfolioBuilder.aspx.cs" Inherits="_24_1639DelMundoPersonalPortfolio.Pages.User.PortfolioBuilder" ValidateRequest="false" %>
...
<%@ Register Src="~/Pages/Admin/Components/ContactsPanel.ascx" TagPrefix="uc" TagName="ContactsPanel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="AdminMainContent" runat="server">
    ...
    <uc:ContactsPanel ID="ucContactsPanel" runat="server" />
</asp:Content>
