...
<div class="admin-panel" data-panel="awards">
    ...
    <div class="add-form">
        ...
        <div class="field"><label>Title</label><div class="input-row"><input type="text" placeholder="DevCup 2026" /></div></div>
        <div class="field"><label>Subtitle</label><div class="input-row"><input type="text" placeholder="2nd Place QCU" /></div></div>
